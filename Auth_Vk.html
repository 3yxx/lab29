...
class Auth_Vk {
	...
	public function get_user() {
		...
		$query = "v=".API_VERSION."&fields=first_name,last_name,nickname,screen_name,sex,bdate,city,country,timezone,photo,photo_medium,photo_big,has_mobile,rate,contacts,education,online,counters&access_token=".$this->token;
